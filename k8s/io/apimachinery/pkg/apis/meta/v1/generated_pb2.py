...
_FIELDS_MAPENTRY = _descriptor.Descriptor(
  name='MapEntry',
  full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Fields.MapEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Fields.MapEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Fields.MapEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FIELDS = _descriptor.Descriptor(
  name='Fields',
  full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Fields',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='map', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Fields.map', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INITIALIZER = _descriptor.Descriptor(
  name='Initializer',
  full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Initializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Initializer.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INITIALIZERS = _descriptor.Descriptor(
  name='Initializers',
  full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Initializers',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pending', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Initializers.pending', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='result', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.Initializers.result', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resourceVersion', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ListOptions.resourceVersion', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timeoutSeconds', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ListOptions.timeoutSeconds', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='limit', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ListOptions.limit', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='continue', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ListOptions.continue', index=6,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MANAGEDFIELDSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fields', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ManagedFieldsEntry.fields', index=4,
...
_OBJECTMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='initializers', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta.initializers', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='finalizers', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta.finalizers', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='clusterName', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta.clusterName', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='managedFields', full_name='k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta.managedFields', index=16,
...
_FIELDS_MAPENTRY.fields_by_name['value'].message_type = _FIELDS
_FIELDS_MAPENTRY.containing_type = _FIELDS
_FIELDS.fields_by_name['map'].message_type = _FIELDS_MAPENTRY
_INITIALIZERS.fields_by_name['pending'].message_type = _INITIALIZER
_INITIALIZERS.fields_by_name['result'].message_type = _STATUS
...
_MANAGEDFIELDSENTRY.fields_by_name['fields'].message_type = _FIELDS
...
_OBJECTMETA.fields_by_name['initializers'].message_type = _INITIALIZERS
...
DESCRIPTOR.message_types_by_name['Initializers'] = _INITIALIZERS
...
Fields = _reflection.GeneratedProtocolMessageType('Fields', (_message.Message,), dict(
  ...
  MapEntry = _reflection.GeneratedProtocolMessageType('MapEntry', (_message.Message,), dict(
    DESCRIPTOR = _FIELDS_MAPENTRY,
    __module__ = 'k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2'
    # @@protoc_insertion_point(class_scope:k8s.io.apimachinery.pkg.apis.meta.v1.Fields.MapEntry)
    ))
  ,
  DESCRIPTOR = _FIELDS,
  __module__ = 'k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2'
  # @@protoc_insertion_point(class_scope:k8s.io.apimachinery.pkg.apis.meta.v1.Fields)
  ))
_sym_db.RegisterMessage(Fields)
_sym_db.RegisterMessage(Fields.MapEntry)
...
Initializers = _reflection.GeneratedProtocolMessageType('Initializers', (_message.Message,), dict(
  DESCRIPTOR = _INITIALIZERS,
  __module__ = 'k8s.io.apimachinery.pkg.apis.meta.v1.generated_pb2'
  # @@protoc_insertion_point(class_scope:k8s.io.apimachinery.pkg.apis.meta.v1.Initializers)
  ))
_sym_db.RegisterMessage(Initializers)
...
_FIELDS_MAPENTRY._options = None
